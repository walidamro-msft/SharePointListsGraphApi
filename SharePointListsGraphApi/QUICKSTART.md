...
**?? IMPORTANT:** Set `appsettings.json` to **Copy to Output Directory**:
...
### Test 3: Export Data
1. Select option **3**
2. Answer **y** to filter by Modified date (or **n** to export all)
3. If filtering: Press Enter to use today's date, or enter custom dates
4. Wait for completion
5. Check for `YYYYMMDDHHmmss.json` file
6. Open in text editor or Excel
